...
- [Google Cloud Account](https://cloud.google.com)
  - With a Service Account with roles
    ...
    - `Service Account` roles used to create/update/delete Service Account
      - __iam.serviceAccounts.actAs__
      - __iam.serviceAccounts.get__
      - __iam.serviceAccounts.create__
      - __iam.serviceAccounts.delete__
      - __iam.serviceAccounts.update__
      - __iam.serviceAccounts.get__
      - __iam.serviceAccounts.getIamPolicy__
      - __iam.serviceAccounts.setIamPolicy__
...
>__NOTE__: All `*.local.tfvars` file are git ignored by this template.
